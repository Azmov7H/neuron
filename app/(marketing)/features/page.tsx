  ...
  return (
    <div className="relative min-h-screen bg-grid overflow-x-hidden">
       <div className="pointer-events-none fixed inset-0 z-0" aria-hidden>
        ...
        <h1 className="text-4xl font-bold text-center mt-20">Features</h1>
        <p className="mt-6 text-lg text-center max-w-2xl mx-auto">
            Explore the cutting-edge features of Neural Mastery, designed to accelerate your cognitive evolution and help you master the art of understanding reality.
        </p>
      </div>
    </div>
  );
