...
export function RecommendedExplorations({
  ...
  onRecommendationClick: (id: string, targetId: string) => void;
}) {
  return (
    <section id="recommendations" className="animate-fade-up delay-300 scroll-mt-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {recommendations.map((rec) => (
          <div
            key={String(rec._id)}
            onClick={() => onRecommendationClick(String(rec._id), rec.targetId)}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">{rec.targetTitle}</h3>
